...
<jsp:include page="./basic/header.jsp" />
    ...
    <nav class="mtable">
        ...
        <!-- 게시글 -->
        <div class="tipsecList" data-id="1">
            <div>
                <input type="checkbox" class="item-checkbox">
                <p>자바스크립트</p>
                <a href="./../admin/articleDetail.html"><p class="tipsec-title" onclick="toggleText(this)">현업 개발자가 전수하는 게시판만들기 꿀팁</p></a>
                <p>전문가</p>
                <p>멘토</p>
                <p>2025-01-11</p>
                <p>151</p>
        ...
        <div class="tipsecList" data-id="2">
            <div>
                <input type="checkbox" class="item-checkbox">
                <p>자바스크립트</p>
                <a href="./../admin/articleDetail.html"><p class="tipsec-title" onclick="toggleText(this)">현업 개발자가 전수하는 게시판만들기 꿀팁</p></a>
