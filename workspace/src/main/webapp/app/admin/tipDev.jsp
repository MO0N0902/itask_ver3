...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/tipDev.css">
<script defer src="${pageContext.request.contextPath}/assets/js/admin/tipDev.js"></script>
</head>
<body>
